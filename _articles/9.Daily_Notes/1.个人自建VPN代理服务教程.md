...
## 三、Aimili-VPNGate 部署 {#三aimili-vpngate-部署}
...
## 四、Nginx 包装规则和使用量 {#四nginx-包装规则和使用量}
...
1. [Purchasing a VPS](#purchasing-a-vps)
2. [Setting Up 3X-UI](#setting-up-3x-ui)
3. [Deploying Aimili-VPNGate](#deploying-aimili-vpngate)
4. [Using Nginx to Wrap Subscriptions, Inject Rules, and Preserve Traffic Usage](#nginx-rules-and-usage-wrapping)
5. [Final Architecture](#final-architecture)
6. [Reference Projects](#reference-projects)
