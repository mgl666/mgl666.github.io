...
description: 从 MLP、CNN、RNN 到生成式模型、Transformer、GNN 与 CLIP 的深度学习模型笔记。
---

<div class="content-zh model-notes" markdown="1">

> 本文是一份深度学习模型速查笔记，按模型家族梳理核心结构、关键公式与典型实现。

| 模型家族 | 核心关键词 | 典型模型 |
| :--- | :--- | :--- |
| 前馈网络 | 全连接、激活函数 | MLP、KAN |
| 卷积网络 | 局部感受野、权重共享 | AlexNet、VGG、ResNet、UNet |
| 序列模型 | 隐状态、门控机制 | RNN、GRU、LSTM |
| 生成模型 | 分布建模、采样 | GAN、VAE、Flow、Diffusion |
| 注意力模型 | Token、Attention | Transformer、ViT、Swin Transformer |
| 图与多模态 | 消息传递、对比学习 | GNN、CLIP |

## 一、MLP

### 1、Linear（线性层）

**定义：** Linear 层是 PyTorch 等深度学习框架中的基本层，执行线性变换：输出为输入向量与权重矩阵的乘积，再加上偏置。

**特点：**

- 仅执行线性变换，不包含非线性激活函数。
- 是构建 FC 层或 MLP 的基本单元；FC 层或 MLP 通常会在 Linear 层后加入非线性激活函数。

### 2、激活函数

延伸阅读：[深度学习中的激活函数](https://zhuanlan.zhihu.com/p/690848035)

### 3、MLP（Multi-Layer Perceptron）

**定义：** MLP 是多层感知机（Multi-Layer Perceptron）的缩写，是一种前馈神经网络，通常包含输入层、一个或多个隐藏层以及输出层。相邻层之间完全连接，网络由多个 Linear 层和激活函数交替组成。
...
<img src="/assets/img/articles/dl-basics/屏幕截图 2024-06-16 162817.png" alt="屏幕截图 2024-06-16 162817" />
...
<div class="convolution-gallery">
  <figure>
    <img alt="No padding, no strides" src="/assets/img/articles/dl-basics/no_padding_no_strides.gif">
    <figcaption>No padding, no strides</figcaption>
  </figure>
  <figure>
    <img alt="Arbitrary padding, no strides" src="/assets/img/articles/dl-basics/arbitrary_padding_no_strides.gif">
    <figcaption>Arbitrary padding, no strides</figcaption>
  </figure>
  <figure>
    <img alt="Half padding, no strides" src="/assets/img/articles/dl-basics/same_padding_no_strides.gif">
    <figcaption>Half padding, no strides</figcaption>
  </figure>
  <figure>
    <img alt="Full padding, no strides" src="/assets/img/articles/dl-basics/full_padding_no_strides.gif">
    <figcaption>Full padding, no strides</figcaption>
  </figure>
  <figure>
    <img alt="No padding, strides" src="/assets/img/articles/dl-basics/no_padding_strides.gif">
    <figcaption>No padding, strides</figcaption>
  </figure>
  <figure>
    <img alt="Padding, strides" src="/assets/img/articles/dl-basics/padding_strides.gif">
    <figcaption>Padding, strides</figcaption>
  </figure>
  <figure>
    <img alt="Padding, strides (odd)" src="/assets/img/articles/dl-basics/padding_strides_odd.gif">
    <figcaption>Padding, strides (odd)</figcaption>
  </figure>
</div>
...
<div class="convolution-gallery">
  <figure>
    <img alt="No padding, no strides, transposed" src="/assets/img/articles/dl-basics/no_padding_no_strides_transposed.gif">
    <figcaption>No padding, no strides, transposed</figcaption>
  </figure>
  <figure>
    <img alt="Arbitrary padding, no strides, transposed" src="/assets/img/articles/dl-basics/arbitrary_padding_no_strides_transposed.gif">
    <figcaption>Arbitrary padding, no strides, transposed</figcaption>
  </figure>
  <figure>
    <img alt="Half padding, no strides, transposed" src="/assets/img/articles/dl-basics/same_padding_no_strides_transposed.gif">
    <figcaption>Half padding, no strides, transposed</figcaption>
  </figure>
  <figure>
    <img alt="Full padding, no strides, transposed" src="/assets/img/articles/dl-basics/full_padding_no_strides_transposed.gif">
    <figcaption>Full padding, no strides, transposed</figcaption>
  </figure>
  <figure>
    <img alt="No padding, strides, transposed" src="/assets/img/articles/dl-basics/no_padding_strides_transposed.gif">
    <figcaption>No padding, strides, transposed</figcaption>
  </figure>
  <figure>
    <img alt="Padding, strides, transposed" src="/assets/img/articles/dl-basics/padding_strides_transposed.gif">
    <figcaption>Padding, strides, transposed</figcaption>
  </figure>
  <figure>
    <img alt="Padding, strides, transposed (odd)" src="/assets/img/articles/dl-basics/padding_strides_odd_transposed.gif">
    <figcaption>Padding, strides, transposed (odd)</figcaption>
  </figure>
</div>
...
<div class="convolution-gallery">
  <figure>
    <img alt="No padding, no stride, dilation" src="/assets/img/articles/dl-basics/dilation.gif">
    <figcaption>No padding, no stride, dilation</figcaption>
  </figure>
</div>
...
<img src="/assets/img/articles/dl-basics/屏幕截图 2024-06-16 155056.png" alt="屏幕截图 2024-06-16 155056" />
...
<div class="model-image-group">
  <img src="/assets/img/articles/dl-basics/subpixel_convolution.PNG" alt="子像素卷积示意图" />
  <img src="/assets/img/articles/dl-basics/pixel_shuffle.PNG" alt="Pixel Shuffle 上采样过程" />
</div>
...
<img src="/assets/img/articles/dl-basics/屏幕截图 2024-06-16 142829.png" alt="AlexNet 网络结构" />
...
<div class="model-image-group">
  <img src="/assets/img/articles/dl-basics/20190813145609582.jpg" alt="VGG 卷积块结构" />
  <img src="/assets/img/articles/dl-basics/屏幕截图 2024-06-16 143919.png" alt="VGG 网络结构" />
</div>
...
<div class="model-image-centered">
  <img src="/assets/img/articles/dl-basics/屏幕截图 2024-06-16 145428.png" alt="屏幕截图 2024-06-16 145428" />
</div>
...
<img src="/assets/img/articles/dl-basics/屏幕截图 2024-06-16 145122.png" alt="ResNet 残差块结构" />
...
<img src="/assets/img/articles/dl-basics/屏幕截图 2024-06-16 150256.png" alt="屏幕截图 2024-06-16 150256" />
...
<img src="/assets/img/articles/dl-basics/1022803-20230920223701431-1999763569.png" alt="1022803-20230920223701431-1999763569" />
...
<img src="/assets/img/articles/dl-basics/13d236a0735a996115cae209645b9165.png" alt="生成式模型分类" />

### 1、GAN

#### （1）模型结构

<img src="/assets/img/articles/dl-basics/31f0cc58b3ed47ad9605823f63df4aff.png" alt="GAN 生成器与判别器结构" />
...
<img src="/assets/img/articles/dl-basics/v2-4fb04f90021d80df6e3f0fc10e60d1ee_720w.png" alt="VAE 编码器与解码器结构" />

**简易理解**

<div class="model-image-group">
  <img src="/assets/img/articles/dl-basics/95970c3624b54780a07e8b7baed32478.png" alt="AE 隐空间插值问题" />
  <img src="/assets/img/articles/dl-basics/413b4ab1836a4d3098a1579eb9551050.png" alt="VAE 隐空间加噪声" />
  <img src="/assets/img/articles/dl-basics/5507701a268446f5963b3a7e9522bf27.png" alt="VAE 连续隐空间插值结果" />
</div>
...
<img src="/assets/img/articles/dl-basics/屏幕截图 2024-06-14 124019.png" alt="Diffusion 模型训练与采样算法" />
...
\text{其中}\quad q(x_{t}|x_{t-1})=\mathcal{N}(x_t|\sqrt{1-\beta_t}x_{t-1},\beta_tI)\\
\text{从而推导出：}\quad q(x_{t}|x_{0})=\mathcal{N}(x_t|\sqrt{\overline{\alpha}}_tx_0,(1-\overline{\alpha}_t)I)
\end{gathered}
$$
...
<img src="/assets/img/articles/dl-basics/屏幕截图 2024-06-14 162853.png" alt="Latent Diffusion 模型架构" />
...
<img src="/assets/img/articles/dl-basics/屏幕截图 2024-03-26 120404.png" alt="屏幕截图 2024-03-26 120404" />
...
<div class="model-image-group">
  <img src="/assets/img/articles/dl-basics/屏幕截图 2024-03-26 122200.png" alt="Self-Attention 计算过程" />
  <img src="/assets/img/articles/dl-basics/屏幕截图 2024-03-26 122558.png" alt="Single-Head Attention 结构" />
</div>
...
<div class="model-image-group">
  <img src="/assets/img/articles/dl-basics/屏幕截图 2024-03-26 123317.png" alt="Multi-Head Attention 计算过程" />
  <img src="/assets/img/articles/dl-basics/屏幕截图 2024-03-26 123427.png" alt="Multi-Head Attention 结构" />
</div>
#### Cross-Attention

<img src="/assets/img/articles/dl-basics/cross_attention_.webp" alt="cross_attention_" />
...
<div class="model-image-group">
  <img src="/assets/img/articles/dl-basics/屏幕截图 2024-03-26 131347.png" alt="ViT 模型架构概览" />
</div>
<img src="/assets/img/articles/dl-basics/20210704124600507.png" alt="20210704124600507" />
...
<img src="/assets/img/articles/dl-basics/屏幕截图 2024-03-26 163529.png" alt="屏幕截图 2024-03-26 163529" />

<img src="/assets/img/articles/dl-basics/屏幕截图 2024-03-26 163936.png" alt="屏幕截图 2024-03-26 163936" />

#### Patch Partiton&Linear Embeding

<img src="/assets/img/articles/dl-basics/屏幕截图 2024-03-26 164434.png" alt="屏幕截图 2024-03-26 164434" />

#### Patch Merging

<img src="/assets/img/articles/dl-basics/d438f7d2265743e585e4a6f716631fe9.png" alt="d438f7d2265743e585e4a6f716631fe9" />

#### 相对位置编码

<img src="/assets/img/articles/dl-basics/v2-2b9e86c4ba5431e021f6652295f2a8fc_r.webp" alt="Swin Transformer 相对位置编码" />

#### W-MSA&SW-MSA

<img src="/assets/img/articles/dl-basics/屏幕截图 2024-03-27 092002.png" alt="屏幕截图 2024-03-27 092002" />
...
<div class="model-image-centered">
  <img src="/assets/img/articles/dl-basics/屏幕截图 2024-09-05 145556.png" alt="屏幕截图 2024-09-05 145556" />
</div>
...
O_1=-\sum_{(i,j)\in E}w_{i,j}\log p_1(v_j\mid v_i)
\end{array}
$$
...
<img src="/assets/img/articles/dl-basics/屏幕截图 2024-09-05 153548.png" alt="屏幕截图 2024-09-05 153548" />
...
<img src="/assets/img/articles/dl-basics/0b5582c12e0bb76ea095f7df43f781ac.png" alt="0b5582c12e0bb76ea095f7df43f781ac" />
...
<img src="/assets/img/articles/dl-basics/屏幕截图 2025-09-19 114447.png" alt="屏幕截图 2025-09-19 114447" />
...
<div class="content-en model-notes" markdown="1">

> This is a quick-reference guide to deep learning models, organized by model family and focused on core architectures, equations, and representative implementations.

| Model family | Key ideas | Representative models |
| :--- | :--- | :--- |
| Feedforward networks | Fully connected layers, activations | MLP, KAN |
| Convolutional networks | Local receptive fields, weight sharing | AlexNet, VGG, ResNet, UNet |
| Sequence models | Hidden states, gating | RNN, GRU, LSTM |
| Generative models | Distribution modeling, sampling | GAN, VAE, Flow, Diffusion |
| Attention models | Tokens, attention | Transformer, ViT, Swin Transformer |
| Graph and multimodal models | Message passing, contrastive learning | GNN, CLIP |
...
Further reading: [Activation functions in deep learning](https://zhuanlan.zhihu.com/p/690848035)
...
<img src="/assets/img/articles/dl-basics/屏幕截图 2024-06-16 162817.png" alt="KAN architecture" />
...
<img src="/assets/img/articles/dl-basics/屏幕截图 2024-06-16 155056.png" alt="Max pooling and average pooling" />
...
<div class="model-image-group">
  <img src="/assets/img/articles/dl-basics/subpixel_convolution.PNG" alt="Sub-pixel convolution" />
  <img src="/assets/img/articles/dl-basics/pixel_shuffle.PNG" alt="Pixel Shuffle upsampling process" />
</div>
...
<img src="/assets/img/articles/dl-basics/屏幕截图 2024-06-16 142829.png" alt="AlexNet architecture" />
...
<div class="model-image-group">
  <img src="/assets/img/articles/dl-basics/20190813145609582.jpg" alt="VGG convolutional block" />
  <img src="/assets/img/articles/dl-basics/屏幕截图 2024-06-16 143919.png" alt="VGG architecture" />
</div>
...
<div class="model-image-centered">
  <img src="/assets/img/articles/dl-basics/屏幕截图 2024-06-16 145428.png" alt="The residual idea" />
</div>
...
<img src="/assets/img/articles/dl-basics/屏幕截图 2024-06-16 145122.png" alt="ResNet residual block" />
...
<img src="/assets/img/articles/dl-basics/屏幕截图 2024-06-16 150256.png" alt="Inception block" />
...
<img src="/assets/img/articles/dl-basics/1022803-20230920223701431-1999763569.png" alt="UNet architecture" />
...
<img src="/assets/img/articles/dl-basics/13d236a0735a996115cae209645b9165.png" alt="Generative model taxonomy" />

### 1. GAN

#### (1) Model structure

<img src="/assets/img/articles/dl-basics/31f0cc58b3ed47ad9605823f63df4aff.png" alt="GAN generator and discriminator architecture" />
...
<img src="/assets/img/articles/dl-basics/v2-4fb04f90021d80df6e3f0fc10e60d1ee_720w.png" alt="VAE encoder and decoder architecture" />

**An intuitive explanation**

<div class="model-image-group">
  <img src="/assets/img/articles/dl-basics/95970c3624b54780a07e8b7baed32478.png" alt="AE latent-space interpolation problem" />
  <img src="/assets/img/articles/dl-basics/413b4ab1836a4d3098a1579eb9551050.png" alt="Adding noise in VAE latent space" />
  <img src="/assets/img/articles/dl-basics/5507701a268446f5963b3a7e9522bf27.png" alt="Continuous VAE latent-space interpolation" />
</div>
...
<img src="/assets/img/articles/dl-basics/屏幕截图 2024-06-14 124019.png" alt="Diffusion training and sampling algorithm" />
...
\begin{gathered}
q(x_{1:T}|x_0)=\prod\limits_{t=1}^Tq(x_{t}|x_{t-1})\\
\text{where}\quad q(x_{t}|x_{t-1})=\mathcal{N}(x_t|\sqrt{1-\beta_t}x_{t-1},\beta_tI)\\
\text{hence}\quad q(x_{t}|x_{0})=\mathcal{N}(x_t|\sqrt{\overline{\alpha}}_tx_0,(1-\overline{\alpha}_t)I)
\end{gathered}
$$
...
<img src="/assets/img/articles/dl-basics/屏幕截图 2024-06-14 162853.png" alt="Latent Diffusion architecture" />
...
<img src="/assets/img/articles/dl-basics/屏幕截图 2024-03-26 120404.png" alt="Self-attention" />
...
<div class="model-image-group">
  <img src="/assets/img/articles/dl-basics/屏幕截图 2024-03-26 122200.png" alt="Self-attention computation" />
  <img src="/assets/img/articles/dl-basics/屏幕截图 2024-03-26 122558.png" alt="Single-head attention architecture" />
</div>
...
<div class="model-image-group">
  <img src="/assets/img/articles/dl-basics/屏幕截图 2024-03-26 123317.png" alt="Multi-head attention computation" />
  <img src="/assets/img/articles/dl-basics/屏幕截图 2024-03-26 123427.png" alt="Multi-head attention architecture" />
</div>
#### Cross-Attention

<img src="/assets/img/articles/dl-basics/cross_attention_.webp" alt="Cross-attention" />
...
<div class="model-image-group">
  <img src="/assets/img/articles/dl-basics/屏幕截图 2024-03-26 131347.png" alt="ViT architecture overview" />
</div>
<img src="/assets/img/articles/dl-basics/20210704124600507.png" alt="ViT architecture" />
...
<img src="/assets/img/articles/dl-basics/屏幕截图 2024-03-26 163529.png" alt="Swin Transformer architecture" />

<img src="/assets/img/articles/dl-basics/屏幕截图 2024-03-26 163936.png" alt="Swin Transformer details" />

#### Patch Partition & Linear Embedding

<img src="/assets/img/articles/dl-basics/屏幕截图 2024-03-26 164434.png" alt="Patch partition and linear embedding" />

#### Patch Merging

<img src="/assets/img/articles/dl-basics/d438f7d2265743e585e4a6f716631fe9.png" alt="Patch merging" />

#### Relative position encoding

<img src="/assets/img/articles/dl-basics/v2-2b9e86c4ba5431e021f6652295f2a8fc_r.webp" alt="Swin Transformer relative position encoding" />

#### W-MSA & SW-MSA

<img src="/assets/img/articles/dl-basics/屏幕截图 2024-03-27 092002.png" alt="Window and shifted-window multi-head self-attention" />
...
<div class="model-image-centered">
  <img src="/assets/img/articles/dl-basics/屏幕截图 2024-09-05 145556.png" alt="DeepWalk" />
</div>
...
<img src="/assets/img/articles/dl-basics/屏幕截图 2024-09-05 153548.png" alt="node2vec" />
...
<img src="/assets/img/articles/dl-basics/0b5582c12e0bb76ea095f7df43f781ac.png" alt="SDNE" />
...
<img src="/assets/img/articles/dl-basics/屏幕截图 2025-09-19 114447.png" alt="CLIP overview" />
